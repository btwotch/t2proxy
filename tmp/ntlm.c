...
void ntlm2_calc_resp(char **nthash, int *ntlen, char **lmhash, int *lmlen,
...
int main(int argc, char **argv) {
	...
	char *passnt2 = "passnt2";
	char *challenge = "a very long challenge";
	int tbofs = 0;
	int tblen = strlen(challenge);

	ntlm2_calc_resp(&nthash, &ntlen, &lmhash, &lmlen, passnt2, challenge, tbofs, tblen);
}
